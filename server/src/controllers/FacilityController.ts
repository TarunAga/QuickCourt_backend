...
export class FacilityController {
  static async bookSport(req: Request, res: Response) {
    console.log("Facility bookSport:", {
      query: req.query,
      params: req.params,
      body: req.body,
    });
    // Merge facilityId from params into booking data
    const bookingData = { ...req.body, facility: req.params.facilityId };
